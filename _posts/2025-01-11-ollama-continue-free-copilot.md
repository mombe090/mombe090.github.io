...
- `vscode` : ouvrez l'appliction -> puis `Extensions` -> rechercher `Continue` -> `Install`
  - ![Continue](../assets/img/content/continue.png)
- `Intellij` :
  - `Intellij Idea` -> puis `Settings` -> puis `Pluggins` -> rechercher `Continue` -> `Install`
  - ![Continue Idea](../assets/img/content/continue-idea.png)
...
- `vscode`: Cliquer sur l'icône de continue parmi les extensions installées
  - ![Deepseek V2 Vscode](../assets/img/content/deepseek-v2-vscode.png)
  ...
  - ![Continue Autocomplete](../assets/img/content/continue-autocomplete.png)
